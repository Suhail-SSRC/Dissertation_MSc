...
int main() {
  ...
  return 0;*/
    ...
    const unsigned int BLOCK_BYTES_LENGTH = 1024 * sizeof(unsigned char);
    ...
    unsigned char* c = aes.EncryptCBC(plain, BLOCK_BYTES_LENGTH, key, iv);
    unsigned char *innew = aes.DecryptCBC(c, BLOCK_BYTES_LENGTH, key, iv);
